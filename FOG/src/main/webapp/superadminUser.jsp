	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li><a href="index.html"><svg class="glyph stroked dashboard-dial"><use xlink:href="#stroked-dashboard-dial"></use></svg> Forside</a></li>
                        <li class="active"><a href="users.html"><svg class="glyph stroked table"><use xlink:href="#stroked-table"></use></svg> Users</a></li>
                        <li><a href="orders.html"><svg class="glyph stroked pencil"><use xlink:href="#stroked-pencil"></use></svg> Orders</a></li>
